  ...
  return (
    <div className="">
      ...
      <div className="h-full w-full flex flex-col justify-center items-center pt-[7rem]">
        ...
        <div className="w-[75%] h-[300px] flex flex-col gap-4 justify-center items-center  bg-gray-200/30 rounded-lg ">
          <h1 className="text-3xl">New Releases and Exclusive Tracks</h1>
          <h2 className="text-xl">
            available <span className="font-semibold">only</span> at{" "}
            <span className="text-pink-400 text-2xl drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">
              Mixcloud
            </span>
          </h2>
          <a
        ...
        <h1 className="text-3xl font-bold mb-8 w-[90%] text-center border-b-2 border-orange-400/60 pb-4 tracking-wider"></h1>
        <div className="flex justify-center items-center h-full w-[75%] mx-auto bg-gradient-to-br from-pink-600/70 to-orange-600/70 rounded-lg py-4">
          <iframe
            width="80%"
            height="500px"
            scrolling="no"
